    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profession', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='dictionary.BaseProfession', verbose_name='Povolání')),
                ('race', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='dictionary.Race', verbose_name='Rasa')),
            ],
            options={
